...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron" id="myContainer">
        <h1>Online Notes</h1>
        <p>Deine Note mit dir, wo auch immer du bist.</p>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" name="loginemail" placeholder="Email" maxlength="50">
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-default pull-left" data-dismiss="modal" data-target="signupModal" datat-toggle="modal">Register</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         ...
                         <div class="form-group">
                                ...
                                <input class="form-control" type="email" name="email" id="email" placeholder="Email Adress" maxlength="30">
                         </div>
                         <div class="form-group">
        ...
        <div class="modal" id="forgotpasswordModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="close" data-dismiss="modal">&times;</button>
                        <h4 id="myModalLabel">Forgot Password? Enter your email adresse: </h4>
                    </div>
    ...
    <div class="footer">
        <div class="container">
            <p>Gaetan Tayou Nganmo Copyright &copy; 2020</p>
        </div>
    </div>
